...
if (isset($_SESSION['login_success']) && $_SESSION['login_success']) {
  ...
  unset($_SESSION['login_success']); // Unset the session variable to avoid showing the message on refresh
}
?>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($login_successful) {
    ...
    header('Location: ' . $_SERVER['PHP_SELF']); // Redirect to the same page to show the SweetAlert message
    exit;
  } else {
