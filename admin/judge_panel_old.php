        ...
        <div class="container">
          <button type="button" class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse">
            ...
            <span class="icon-bar"></span>
               ...
               <a class="brand" href="#"><img src="img/<?php echo $company_logo; ?>" width="23" height="23" />&nbsp; <font size="3">EventJudging System</font></a>
                   ...
                   <a href="judge_panel.php?judge_ctr=<?php echo $judge_ctr; ?>&subevent_id=<?php echo $subevent_id; ?>&contestant_id=allTally">View Tally</a>  
                     <?php  } 
                                        ...
                                        <div class="container">
                                          ...
                                          <tr>
                                          <td rowspan="3" width="10"><img src="../img/<?php echo $company_logo; ?>" width="35" height="35" /> <br /><br /><br /> <br /> <br /> <br /></td>
                                         </tr>
                                         <tr>
                                          <td align="center">
