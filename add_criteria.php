...
<html lang="en">
  ...
  <body>
                      ...
                      <tr>
                        <td>
                          ...
                          <select name="crit_ctr" class="form-control">
                            ...
                            while ($n1 < 8) { 
                              $n1++;
                              $cont_query = $conn->query("SELECT * FROM criteria WHERE criteria_ctr='$n1' AND subevent_id='$sub_event_id'") or die($conn->error);
                              if ($cont_query->num_rows == 0) {
    ...
    <script>
      ...
      alert('Criteria <?php echo htmlspecialchars($criteria); ?> added successfully!');
    </script>
    <?php } ?>
