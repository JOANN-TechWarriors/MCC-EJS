...
<button class="btn btn-success pull-right" data-toggle="collapse" data-target="#judge" data-parent="#myGroup"><i class="icon-chevron-right"></i> <strong>STUDENT</strong></button>  
...
<div class="input-group">
      ...
      <form method="POST" action="judge_profile.php" >
          ...
          <input id="myInputJC" style="font-size: large; height: 45px !important;" class="form-control btn-block" name="judge_code" type="password" placeholder="Enter Judge's Code" />
            <p><input style="padding-top: 0px !important; margin-top: 0px !important;" type="checkbox" onclick="myFunctionJC()"/> <strong>Show ID #</strong></p>
