...
if (isset($_POST['vote'])) {
    ...
    mysqli_query($conn,"UPDATE contestants SET txtPollScore = txtPollScore+1 WHERE contestant_id='$contestant_id'");
	} else {
...
<?php 
$geteventinfo = new PDO($conn,"SELECT * FROM contestants c, sub_event s WHERE c.subevent_id='$event' AND s.subevent_id='$event'");
